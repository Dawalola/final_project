...
5.
Count the frequency of each device used by gender and create a bar plot using `ggplot2`.
6.
...
2.
Run the following command in your terminal or command prompt: 'make install.
## Additional Notes
